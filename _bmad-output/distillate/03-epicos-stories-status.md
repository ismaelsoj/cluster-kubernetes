...
- 2.1 PostgreSQL (Wave 1): Baixa Complexidade — deploy GitOps em `keycloak-auth`, sync-wave:"1", tag imutável postgres:16.3, NetworkPolicy restringindo acesso, probes, labels, comentário pt-BR
